(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-header")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-header")) {
                    document.documentElement.classList.toggle("menu-open");
                    if (window.innerWidth < 992) bodyLockToggle();
                }
            }));
        }
        function menuClose() {
        ...
        if (window.innerWidth < 992) paralaxMouse.forEach((element => {
            element.removeAttribute("data-prlx-mouse");
            element.removeAttribute("data-prlx-a");
        }));
        class MousePRLX {
            ...
            paralaxMouseInit(paralaxMouse) {
                paralaxMouse.forEach((el => {
                    ...
                    const paramСoefficientX = el.dataset.prlxCx ? +el.dataset.prlxCx : 30;
                    const paramСoefficientY = el.dataset.prlxCy ? +el.dataset.prlxCy : 30;
